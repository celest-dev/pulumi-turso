...
export class DatabaseToken extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseToken {
        return new DatabaseToken(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'turso:index:DatabaseToken';
     ...
     */
    declare public readonly authorization: pulumi.Output<enums.DatabaseTokenAuthorization | undefined>;
    /**
...
export interface DatabaseTokenArgs {
     ...
     * The authorization level for the token. Defaults to full-access if not specified.
     */
    authorization?: pulumi.Input<enums.DatabaseTokenAuthorization>;
    /**
     * The name of the database to create the token for.
     */
